              ...
              <div>
                ...
                <div style={{ marginBottom: '10px' }}>
                  ...
                  <div>
                    ...
                    {Object.keys(DataManager.decisionsByCategory).length}
                  </div>
                  <div>
              ...
              <div>
                  ...
                  {filteredDecisions.map(decision => (
                    <div
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        background:
                          selectedDecision?.id === decision.id ? '#f0f7ff' : 'transparent',
                      }}
                    >
                      <div>
                ...
                {selectedDecision && (
                  ...
                  >
                    ...
                    <div>
                      <strong>Required:</strong> {selectedDecision.required ? 'Yes' : 'No'}
                    </div>
                    <div>
                      <strong>Optional:</strong> {selectedDecision.optional ? 'Yes' : 'No'}
                    </div>
                    <div>
                    ...
                    <div>
                      <strong>Unlocks:</strong> {selectedDecision.unlocks.join(', ') || 'None'}
                    </div>
                    ...
                    <div style={{ maxHeight: '250px', overflowY: 'auto' }}>
                      {nodes.map(node => (
                        ...
                        >
                          ...
                          <div style={{ color: '#666' }}>
                            ID: {node.id}, Pos: ({Math.round(node.position.x)},{' '}
